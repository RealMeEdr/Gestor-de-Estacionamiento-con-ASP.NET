<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Actualizar_mi_info.aspx.cs" Inherits="Administrador_de_Estacionamiento.inicio_de_Usuarios.Actualizar_mi_info" %>
...
<div class="divs" align="center">
    ...
    <div class="divs">
        ...
        <br />
        <div class="divs">
            <h3 id="titulo-estacionamiento">Actualizar mi Información</h3>
            </div>
        <br />
         <div class="divs">
            ...
            <main class="container">
             ...
             <div class="divs" style="overflow-y:hidden; overflow-x:auto; width:100%">
            <table align="center" cellspacing="3" class="auto-style4" aria-orientation="horizontal">
                <tr>
                    <td class="auto-style26"><strong>RFC :</strong></td>
                    <td colspan="3" class="auto-style27">
                        <asp:TextBox ID="txtRFC" runat="server" Width="200px" placeholder="Ingrese su RFC" MaxLength="14" EnableViewState="False" ClientIDMode="Static" ViewStateMode="Disabled"></asp:TextBox>
                        &nbsp;&nbsp;
                        <asp:Button ID="btnBuscar" runat="server" CssClass="btnsombra btnmex btn-outline-verdemx" OnClick="btnBuscar_Click" Text="Buscar" Font-Bold="False" />
                    &nbsp;&nbsp;<br />
                ...
                <tr>
                    <td class="auto-style21">
                        &nbsp;</td>
                    <td colspan="6" class="auto-style22"></td>
                </tr>
               
                <tr>
                    <td class="auto-style19"><strong>VEHÍCULO Nº 2 :</strong></td>
                    <td colspan="6" class="auto-style20">
                        <asp:TextBox ID="txtMARCA2" runat="server" EnableViewState="False"></asp:TextBox>
                        <asp:TextBox ID="txtMODELO2" runat="server" MaxLength="50" EnableTheming="True" EnableViewState="False"></asp:TextBox>
                ...
                <tr>
                    <td class="auto-style1" colspan="2">
                        <asp:TextBox ID="txtADMIN1" runat="server" Width="300px" Height="28px" ReadOnly="True" EnableViewState="False"></asp:TextBox>
                    </td>
                    <td class="auto-style7" colspan="3">
                    <asp:Button ID="btnAbrir" runat="server" Text="Actualizar" class="btnsombra btnmex btn-outline-verdemx" data-toggle="modal" data-target="#ventanaModal" UseSubmitBehavior="True" OnClientClick="return false;" Width="100px"/>
