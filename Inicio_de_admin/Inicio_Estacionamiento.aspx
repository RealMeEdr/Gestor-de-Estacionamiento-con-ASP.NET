<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inicio_Estacionamiento.aspx.cs" Inherits="Administrador_de_Estacionamiento.Inicio_de_admin.Inicio_Estacionamiento" %>
        ...
        <header class="header">
            ...
            <nav>
                ...
                <a href="../Inicio_de_admin/Inicio_Estacionamiento.aspx">
                    <img src="../img/horizontal2.png" height="90px" class="auto-style1" tooltip="Regresa al menú principal" /></a>
            </nav>
            <!-- nav de los links -->
...
<div class="divs" align="center">
    ...
    <div class="divs">
        ...
        <br />
        <div class="divs">
            <h3 id="titulo-estacionamiento">Estacionamiento de los Servidores Públicos</h3>
        </div>
        <br />
        <div class="divs">
            ...
            <asp:TextBox ID="txtResultado" runat="server" ToolTip="número de cajón a buscar" Width="20%" PLACEHOLDER="Nº de Estacionamiento" AutoCompleteType="HomePhone" CausesValidation="True"></asp:TextBox>
&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnAbrir" runat="server" CssClass="btnmex btnsombra btn-outline-verdemx" OnClick="btnBuscar_Click1" Text="Buscar Ocupante de Estacionamiento" UseSubmitBehavior="true" ToolTip="Busca el cajón que desea encontrar" />
            &nbsp;&nbsp;&nbsp;
